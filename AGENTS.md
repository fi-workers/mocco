...
Full workflow: [docs/guides/pr-workflow.md](./docs/guides/pr-workflow.md). Executable versions: `/pr` (build → senior team review → strengthened tests → PR) and `/pr-review` (posted-PR review loop → fixes → "Ready to merge").
